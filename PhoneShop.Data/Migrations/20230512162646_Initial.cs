        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    O_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    O_Date = table.Column<DateTime>(type: "date", nullable: false, defaultValue: new DateTime(2023, 5, 12, 23, 26, 46, 225, DateTimeKind.Local).AddTicks(4139)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    P_Color = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Storage = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Ram = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Screen_Size = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Resolution = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Operating_System = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Camera = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_BatteryCapacity = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    P_Connectivity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    P_Weights = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
